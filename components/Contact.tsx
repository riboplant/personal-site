        ...
        <div className="flex flex-wrap items-center gap-4">
          ...
          <div className="flex gap-3">
            <a
              ...
              className="p-3 border border-gray-200 rounded-lg text-gray-600 hover:border-gray-300 hover:bg-white hover:text-gray-900 transition-all"
              aria-label="GitHub"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 border border-gray-200 rounded-lg text-blue-600 hover:border-blue-200 hover:bg-white transition-all"
              aria-label="LinkedIn"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
